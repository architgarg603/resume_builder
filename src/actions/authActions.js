...
export const login = (userDetails)=>{
    return (dispatch , getState , {getFirebase , getFirestore}) =>{
        ...
        .then(()=>{
            ...
            dispatch({type:"UPDATE_CONTACT" , contactDetails : data.contactDetails})
            dispatch({type:"UPDATE_EDUCATION" , educationDetails: data.educationDetails})
            dispatch({type:"CHANGE_SKIN" , skinCode : data.document.skinCode});
        })
        .catch( err =>{
